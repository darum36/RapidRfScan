...
//  motion_init();
  while (1)
  {
	  ...
	  //tempCount = htim1.Instance->CNT;
	  //countOFCounts = tempCount;
	  UART(&huart1);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LIM_1_Pin LIM_1C1_Pin LIM_2_Pin LIM_2C3_Pin
                           TRIG_IN_Pin */
  GPIO_InitStruct.Pin = LIM_1_Pin|LIM_1C1_Pin|LIM_2_Pin|LIM_2C3_Pin
                          |TRIG_IN_Pin;
  ...
  GPIO_InitStruct.Pin = AXIS2_Pin|ENC_IND_1_Pin|ENC_IND_2_Pin|ENC_A2_Pin
                          |ENC_B2_Pin|ENC_B1_Pin|ENC_A1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : LIM_HOME_1_Pin LIM_HOME_2_Pin */
  GPIO_InitStruct.Pin = LIM_HOME_1_Pin|LIM_HOME_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
