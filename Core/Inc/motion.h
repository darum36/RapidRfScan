...
//void Deceleration(int Motor,uint32_t Dcc);
//void Moving (int Motor,uint32_t M_Steps);
//void Jogging(int Motor,uint32_t Vmax,uint32_t Acc);
//void Point_to_Point(int Motor, uint32_t Vmax, uint32_t Acc, uint64_t Steps);
